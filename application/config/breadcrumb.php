...
/**
 * ----------------------------------
 * Config: Breadcrumb enable/disable
 * ----------------------------------
 * Default value:
 * $config['enable'] = TRUE;
 *
 * If TRUE then breadcrumb will process else breadcrumb will be disabled
 */
$config['enable'] = TRUE;
 ...
 * $config['delimiter'] = ' > ';
 */
$config['delimiter'] = '<li class="div-arrow"><span>&nbsp;</span></li>';
 ...
 * $lang['read'] = 'Baca';
 */
$config['partial_replace'] = array('faq'=>'FAQ','site-fees'=>'Site Fees');
 ...
 */
$config['exclude'] = array('show','view');
...
$config['wrapper'] = '<div id="crumbs"><div class="pagin"><ul class="clearfix">|</ul></div></div><div class="clear"></div>';
$config['wrapper_inline'] = '<li>|</li>';
$config['wrapper_inline_first'] = '<li class="home">|</li>';
